...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen w-full bg-foreground flex flex-col items-center justify-start pt-32 pb-20 px-6 md:px-12 overflow-hidden gap-12">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col items-center text-center gap-10 md:gap-16">
        
        {/* 2. Top Section: Status Badge + Profile Image */}
        <div className="flex flex-col items-center gap-8">
          ...
          {/* Main Profile Visual */}
          <div className="relative opacity-0 animate-fade-up stagger-1 group z-20">
            ...
            <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-full p-1 bg-gradient-to-br from-white/20 to-transparent backdrop-blur-xl">
              <div className="w-full h-full rounded-full overflow-hidden border-4 border-background/10 relative z-10 bg-black/20">
              ...
              {/* Floating Glass Card - Left (Experience) - Hidden on Mobile to prevent clutter */}
              <div className="absolute -left-20 top-1/2 -translate-y-1/2 hidden md:flex items-center gap-3 px-4 py-3 rounded-2xl bg-background/10 backdrop-blur-xl border border-white/10 shadow-xl -translate-x-4 group-hover:translate-x-0 transition-transform duration-500 z-30 min-w-[140px]">
              ...
              {/* Floating Glass Card - Right (Certification) - Hidden on Mobile */}
              <div className="absolute -right-20 top-1/2 -translate-y-1/2 hidden md:flex items-center gap-3 px-4 py-3 rounded-2xl bg-background/10 backdrop-blur-xl border border-white/10 shadow-xl translate-x-4 group-hover:translate-x-0 transition-transform duration-500 z-30 min-w-[140px]">
                 <div className="p-2 bg-background/20 rounded-lg">
        ...
        {/* 3. Text Section: Headline & Subheadline */}
        <div className="opacity-0 animate-fade-up stagger-2 space-y-6 max-w-4xl relative z-10">
        ...
        {/* 4. Action Section: Buttons & Competencies */}
        <div className="flex flex-col items-center gap-10 w-full opacity-0 animate-fade-up stagger-3">
          ...
          <div className="pt-8 border-t border-white/5 w-full max-w-2xl">
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-6 left-0 right-0 flex justify-center opacity-0 animate-fade-up stagger-5">
        <a href="#experience" className="animate-bounce p-3 text-background/20 hover:text-white transition-colors duration-300">
