...
const Hero = () => {
  return (
    <section id="home" className="relative w-full flex flex-col items-center justify-center pt-32 pb-16 px-6 overflow-hidden min-h-[90vh]">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center gap-8">
        ...
        {/* PROFILE ROW - Locked Grid (No Overlap) */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12 animate-fade-up opacity-0" style={{ animationDelay: '100ms' }}>
          
          {/* Left Badge: Certifications */}
          <div className="hidden md:flex flex-col items-end">
            <div className="px-4 py-2 bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-xl shadow-lg flex items-center gap-3 hover:scale-105 transition-transform cursor-default">
          ...
          {/* Center: Profile Image (Scaled Down) */}
          <div className="relative group">
            <div className="absolute inset-0 bg-gradient-to-b from-purple-500/20 to-blue-500/10 rounded-full blur-2xl transform group-hover:scale-105 transition-transform duration-700 opacity-60" />
            <div className="relative w-32 h-32 rounded-full p-1.5 bg-gradient-to-b from-white/10 to-white/5 border border-white/10 backdrop-blur-md shadow-2xl z-10">
        ...
        <div className="flex md:hidden gap-3 -mt-2 animate-fade-up opacity-0" style={{ animationDelay: '150ms' }}>
           <div className="px-3 py-1.5 bg-white/5 border border-white/10 rounded-lg flex items-center gap-2 backdrop-blur-md">
        ...
        {/* Headline - "Zoomed Out" Text Size */}
        <div className="space-y-4 max-w-3xl animate-fade-up opacity-0" style={{ animationDelay: '200ms' }}>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto animate-fade-up opacity-0" style={{ animationDelay: '300ms' }}>
          <a 
            href="#projects"
            className="w-full sm:w-auto px-6 py-3 bg-white text-black rounded-full font-bold text-xs uppercase tracking-wide hover:bg-gray-200 transition-all shadow-lg hover:scale-105 flex items-center justify-center"
          >
            View Work
          </a>
          <a 
            ...
            className="w-full sm:w-auto px-6 py-3 bg-white/5 border border-white/10 text-white rounded-full font-bold text-xs uppercase tracking-wide hover:bg-white/10 backdrop-blur-md transition-all flex items-center justify-center gap-2 hover:scale-105"
          >
