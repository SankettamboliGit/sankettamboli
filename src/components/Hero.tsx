      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center flex flex-col items-center gap-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 animate-fade-up opacity-0" style={{ animationDelay: '100ms' }}>
          ...
          <div className="relative group">
            ...
            <div className="relative w-56 h-56 md:w-72 md:h-72 rounded-full p-2 bg-gradient-to-b from-white/10 to-white/5 border border-white/10 backdrop-blur-md shadow-2xl z-10">
        ...
        {/* Headline */}
        <div className="space-y-5 max-w-4xl animate-fade-up opacity-0" style={{ animationDelay: '200ms' }}>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto animate-fade-up opacity-0" style={{ animationDelay: '300ms' }}>
          <a href="#projects" className="w-full sm:w-auto px-8 py-3.5 bg-white text-black rounded-full font-bold text-xs uppercase tracking-wide hover:bg-gray-200 transition-all shadow-lg hover:scale-105 flex items-center justify-center">
            View Projects
          </a>
          <a href="https://drive.google.com/file/d/1CozgNLDwsi8hUY0Ead2Efa9Ibf5BNKqk/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto px-8 py-3.5 bg-white/5 border border-white/10 text-white rounded-full font-bold text-xs uppercase tracking-wide hover:bg-white/10 backdrop-blur-md transition-all flex items-center justify-center gap-2 hover:scale-105">
