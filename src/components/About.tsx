      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative group animate-fade-up stagger-2">
            ...
            <div className="relative bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[2rem] p-8 md:p-12 hover:border-white/20 transition-colors shadow-2xl">
              <div className="flex justify-between items-start mb-10">
                <div>
                  <h3 className="text-3xl font-bold text-white mb-1">Sanket Tamboli</h3>
                  <p className="text-white/60 text-lg">Product Operations Manager</p>
                </div>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-white/90 font-medium">Vadodara, Gujarat (Remote Ready)</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-white/90 font-medium">Postgraduate in HRM (2021)</p>
                  </div>
                </div>

                <div className="pt-8 border-t border-white/10">
                  <p className="text-xs text-white/40 uppercase tracking-wider font-bold mb-4">Certifications</p>
                  <div className="flex flex-wrap gap-2">
                    {["AI Product Mgmt", "Lean Six Sigma", "Scrum Master"].map((c) => (
                      <Badge key={c} variant="secondary" className="bg-white/5 text-white/80 border-white/10 hover:bg-white/10 font-medium py-1.5 px-3">
                        {c}
                      </Badge>
                    ))}
                  </div>
