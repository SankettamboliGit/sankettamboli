        ...
        <div className="flex flex-col gap-4 mb-16 animate-fade-up stagger-2 w-full max-w-2xl mx-auto">
          ...
          >
            <div className="flex items-center gap-4 md:gap-6">
              ...
              <div>
                <p className="text-blue-400/60 text-[10px] uppercase tracking-wider font-bold mb-0.5">LinkedIn</p>
                <p className="text-blue-100 font-medium text-sm md:text-lg font-sans">linkedin.com/in/sanket-tamboli</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-4 md:gap-6">
              ...
              <div>
                ...
                <p className="text-green-100 font-medium text-sm md:text-lg font-sans">{phone}</p>
              </div>
            </div>
            <ArrowUpRight className="w-5 h-5 text-green-400/50 group-hover:text-green-400 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
          </a>
        </div>
      </div>
    </section>
