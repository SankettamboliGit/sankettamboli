...
const Projects = () => {
  ...
  return (
    <section id="projects" className="py-24 md:py-32 px-6 bg-[#030303] relative overflow-hidden">
      ...
      <Dialog open={!!selectedProject} onOpenChange={() => setSelectedProject(null)}>
        <DialogContent className="max-w-3xl p-0 border-white/10 bg-black/90 backdrop-blur-3xl shadow-2xl overflow-hidden rounded-[2rem] text-white [&>button]:hidden">
          ...
          <div className="p-8 space-y-8 max-h-[60vh] overflow-y-auto bg-black/50">
            {selectedProject && (
              <>
